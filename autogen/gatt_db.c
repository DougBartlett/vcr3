...
{
  0x32, 0xae, 0xa6, 0x1b, 0x01, 0xa7, 0x90, 0x8a, 0x72, 0x49, 0x1f, 0xdf, 0x5c, 0x34, 0x75, 0x44, 
  0x7c, 0x6d, 0x21, 0xb8, 0x6f, 0xc3, 0xaa, 0x96, 0x0e, 0x4e, 0x60, 0xee, 0x8f, 0xa9, 0x0b, 0xed, 
  0x57, 0x65, 0xda, 0xb2, 0x93, 0xb3, 0x59, 0x9b, 0xa1, 0x43, 0x9b, 0x1d, 0xe3, 0x8f, 0xe3, 0x09, 
...
GATT_DATA(sli_bt_gattdb_attribute_chrvalue_t gattdb_attribute_field_31) = {
  .properties = 0x08,
  .max_len = 48,
  .data = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, },
};
...
GATT_DATA(sli_bt_gattdb_attribute_chrvalue_t gattdb_attribute_field_26) = {
  ...
  .max_len = 40,
  .len = 0,
  .data = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, }
};
GATT_DATA(const sli_bt_gattdb_value_t gattdb_attribute_field_24) = {
  .len = 16,
  .data = { 0xd8, 0xc8, 0x6a, 0xc7, 0xbe, 0xdc, 0x23, 0xaa, 0x9a, 0x41, 0x8c, 0xa8, 0xc2, 0x5b, 0xd2, 0x63, }
};
...
GATT_DATA(const sli_bt_gattdb_value_t gattdb_attribute_field_17) = {
  .len = 8,
  .data = { 0x56, 0x43, 0x52, 0x20, 0x47, 0x65, 0x6e, 0x33, }
};
GATT_DATA(const sli_bt_gattdb_value_t gattdb_attribute_field_15) = {
  .len = 13,
  .data = { 0x44, 0x6f, 0x75, 0x67, 0x20, 0x42, 0x61, 0x72, 0x74, 0x6c, 0x65, 0x74, 0x74, }
};
...
GATT_DATA(sli_bt_gattdb_attribute_chrvalue_t gattdb_attribute_field_10) = {
  .properties = 0x0a,
  .max_len = 37,
  .data = { 0x56, 0x69, 0x62, 0x72, 0x6f, 0x74, 0x61, 0x63, 0x74, 0x69, 0x6c, 0x65, 0x20, 0x43, 0x6f, 0x6f, 0x72, 0x64, 0x69, 0x6e, 0x61, 0x74, 0x65, 0x64, 0x20, 0x52, 0x65, 0x73, 0x65, 0x74, 0x20, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, },
};
...
GATT_DATA(const sli_bt_gattdb_attribute_t gattdb_attributes_map[]) = {
  ...
  { .handle = 0x1c, .uuid = 0x0002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x05, .characteristic = { .properties = 0x10, .char_uuid = 0x8001 } },
  { .handle = 0x1d, .uuid = 0x8001, .permissions = 0x800, .caps = 0xffff, .state = 0x00, .datatype = 0x01, .dynamicdata = &gattdb_attribute_field_28 },
  ...
  { .handle = 0x20, .uuid = 0x8002, .permissions = 0x802, .caps = 0xffff, .state = 0x00, .datatype = 0x01, .dynamicdata = &gattdb_attribute_field_31 },
